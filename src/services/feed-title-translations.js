...
export function createFeedTitleTranslations({
  ...
  function serializeUserFeed(userId, feed, translationSettings = null, feedFetchSettings = null) {
    ...
    return {
      ...
      fetch_request_method: fetchSettings.request_method,
      fetch_request_body: fetchSettings.request_body,
      ...
      fetch_html_items_selector: fetchSettings.html_items_selector,
      fetch_html_title_selector: fetchSettings.html_title_selector,
      fetch_html_link_selector: fetchSettings.html_link_selector,
      fetch_html_date_selector: fetchSettings.html_date_selector,
      fetch_html_summary_selector: fetchSettings.html_summary_selector,
      fetch_html_content_selector: fetchSettings.html_content_selector,
