export function createReaderFeedSettings({ els, getFeedById, setStatus, state }) {
  ...
  function resetForm() {
    ...
    els.feedSettingsFetchMethod.value = "GET"
    els.feedSettingsFetchRequestBody.value = ""
    ...
    els.feedSettingsFetchHtmlItemsSelector.value = ""
    els.feedSettingsFetchHtmlTitleSelector.value = ""
    els.feedSettingsFetchHtmlLinkSelector.value = ""
    els.feedSettingsFetchHtmlDateSelector.value = ""
    els.feedSettingsFetchHtmlSummarySelector.value = ""
    els.feedSettingsFetchHtmlContentSelector.value = ""
  ...
  function openModal(feedId) {
    ...
    els.feedSettingsFetchMethod.value = feed.fetch_request_method || "GET"
    els.feedSettingsFetchRequestBody.value = feed.fetch_request_body || ""
    ...
    els.feedSettingsFetchHtmlItemsSelector.value = feed.fetch_html_items_selector || ""
    els.feedSettingsFetchHtmlTitleSelector.value = feed.fetch_html_title_selector || ""
    els.feedSettingsFetchHtmlLinkSelector.value = feed.fetch_html_link_selector || ""
    els.feedSettingsFetchHtmlDateSelector.value = feed.fetch_html_date_selector || ""
    els.feedSettingsFetchHtmlSummarySelector.value = feed.fetch_html_summary_selector || ""
    els.feedSettingsFetchHtmlContentSelector.value = feed.fetch_html_content_selector || ""
